...
from .options import EntranceRandomization, ExcludeGingerIsland, StardewValleyOptions, Tilesanity
...
class RegionFactory(Protocol):
    def __call__(self, name: str, regions: Iterable[str]) -> RegionName:
...
vanilla_regions = [
    ...
    RegionData(RegionName.forest,
               [Entrance.forest_to_town, Entrance.enter_secret_woods, Entrance.forest_to_wizard_tower, Entrance.forest_to_marnie_ranch,
                ...
                LogicEntrance.racoon_tree, LogicEntrance.fish_in_waterfall, LogicEntrance.attend_flower_dance, LogicEntrance.attend_trout_derby,
    ...
    RegionData(RegionName.mountain,
               [Entrance.mountain_to_railroad, Entrance.mountain_to_tent, Entrance.mountain_to_carpenter_shop,
                ...
                Entrance.mountain_to_leo_treehouse], main_point=(45, 23)),
    RegionData(RegionName.leo_treehouse, is_ginger_island=True),
    RegionData(RegionName.maru_room),
    RegionData(RegionName.tunnel_entrance, [Entrance.tunnel_entrance_to_bus_tunnel], main_point=(31, 28)),
    ...
    RegionData(RegionName.town,
               [Entrance.town_to_community_center, Entrance.town_to_beach, Entrance.town_to_hospital, Entrance.town_to_pierre_general_store,
                ...
                LogicEntrance.attend_spirit_eve, LogicEntrance.attend_winter_star], main_point=(42, 57)),
    RegionData(RegionName.beach,
               [Entrance.beach_to_willy_fish_shop, Entrance.enter_elliott_house, Entrance.enter_tide_pools, LogicEntrance.fishing, LogicEntrance.attend_luau,
                LogicEntrance.attend_moonlight_jellies, LogicEntrance.attend_night_market, LogicEntrance.attend_squidfest], main_point=(28, 21)),
    RegionData(RegionName.railroad, [Entrance.enter_bathhouse_entrance, Entrance.enter_witch_warp_cave], main_point=(45, 41)),
    ...
    RegionData(RegionName.secret_woods, main_point=(9, 8)),
    RegionData(RegionName.desert, [Entrance.enter_skull_cavern_entrance, Entrance.enter_oasis, LogicEntrance.attend_desert_festival], main_point=(41, 24)),
...
vanilla_connections = [
    ...
    ConnectionData(Entrance.farmhouse_to_farm, RegionName.farm, exit_coord=(64, 15)),
    ConnectionData(Entrance.downstairs_to_cellar, RegionName.cellar),
    ConnectionData(Entrance.farm_to_backwoods, RegionName.backwoods, entry_coord=(40, 1), exit_coord=(14, 38)),
    ConnectionData(Entrance.farm_to_bus_stop, RegionName.bus_stop, entry_coord=(78, 17), exit_coord=(11, 23)),
    ConnectionData(Entrance.farm_to_forest, RegionName.forest, entry_coord=(40, 63), exit_coord=(68, 1)),
    ConnectionData(Entrance.farm_to_farmcave, RegionName.farm_cave, entry_coord=(34, 6), flag=RandomizationFlag.NON_PROGRESSION),
    ConnectionData(Entrance.enter_greenhouse, RegionName.greenhouse, entry_coord=(28, 16)),
    ...
    ConnectionData(Entrance.backwoods_to_mountain, RegionName.mountain, entry_coord=(48, 14), exit_coord=(1, 13)),
    ConnectionData(Entrance.bus_stop_to_town, RegionName.town, entry_coord=(43, 23), exit_coord=(1, 54)),
    ConnectionData(Entrance.bus_stop_to_tunnel_entrance, RegionName.tunnel_entrance, entry_coord=(13, 8), exit_coord=(48, 30)),
    ConnectionData(Entrance.tunnel_entrance_to_bus_tunnel, RegionName.bus_tunnel, entry_coord=(23, 30), flag=RandomizationFlag.NON_PROGRESSION),
    ConnectionData(Entrance.take_bus_to_desert, RegionName.desert, entry_coord=(17, 12), exit_coord=(18, 27)),
    ConnectionData(Entrance.forest_to_town, RegionName.town, entry_coord=(118, 25), exit_coord=(1, 90)),
    ConnectionData(Entrance.forest_to_wizard_tower, RegionName.wizard_tower, entry_coord=(5, 27),
    ...
    ConnectionData(Entrance.forest_to_marnie_ranch, RegionName.ranch, entry_coord=(90, 16),
                   flag=RandomizationFlag.NON_PROGRESSION | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.forest_to_leah_cottage, RegionName.leah_house, entry_coord=(104, 33),
                   flag=RandomizationFlag.BUILDINGS | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.enter_secret_woods, RegionName.secret_woods, entry_coord=(1, 7), exit_coord=(58, 15)),
    ConnectionData(Entrance.forest_to_sewer, RegionName.sewer, entry_coord=(94, 100), flag=RandomizationFlag.BUILDINGS),
    ...
    ConnectionData(Entrance.town_to_sewer, RegionName.sewer, entry_coord=(35, 97), flag=RandomizationFlag.BUILDINGS),
    ConnectionData(Entrance.enter_mutant_bug_lair, RegionName.mutant_bug_lair, flag=RandomizationFlag.BUILDINGS),
    ConnectionData(Entrance.mountain_to_railroad, RegionName.railroad, entry_coord=(9, 1), exit_coord=(29, 60)),
    ConnectionData(Entrance.mountain_to_tent, RegionName.tent, entry_coord=(29, 7),
                   flag=RandomizationFlag.NON_PROGRESSION | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.mountain_to_leo_treehouse, RegionName.leo_treehouse, entry_coord=(16, 8),
                   flag=RandomizationFlag.BUILDINGS | RandomizationFlag.LEAD_TO_OPEN_AREA | RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.mountain_to_carpenter_shop, RegionName.carpenter, entry_coord=(12, 26),
                   flag=RandomizationFlag.NON_PROGRESSION | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.mountain_to_maru_room, RegionName.maru_room, entry_coord=(8, 21),
                   flag=RandomizationFlag.BUILDINGS | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.enter_sebastian_room, RegionName.sebastian_room, flag=RandomizationFlag.BUILDINGS),
    ConnectionData(Entrance.mountain_to_adventurer_guild, RegionName.adventurer_guild, entry_coord=(76, 9),
                   flag=RandomizationFlag.BUILDINGS | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ...
    ConnectionData(Entrance.mountain_to_town, RegionName.town, entry_coord=(15, 39), exit_coord=(81, 1)),
    ConnectionData(Entrance.town_to_community_center, RegionName.community_center, entry_coord=(52, 20),
    ...
    ConnectionData(Entrance.town_to_hospital, RegionName.hospital, entry_coord=(36, 56),
                   flag=RandomizationFlag.PELICAN_TOWN | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.enter_harvey_room, RegionName.harvey_room, flag=RandomizationFlag.BUILDINGS),
    ConnectionData(Entrance.town_to_pierre_general_store, RegionName.pierre_store, entry_coord=(43, 57),
                   flag=RandomizationFlag.PELICAN_TOWN | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.enter_sunroom, RegionName.sunroom, flag=RandomizationFlag.BUILDINGS),
    ConnectionData(Entrance.town_to_clint_blacksmith, RegionName.blacksmith, entry_coord=(94, 82),
                   flag=RandomizationFlag.PELICAN_TOWN | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.town_to_saloon, RegionName.saloon, entry_coord=(45, 71),
                   flag=RandomizationFlag.PELICAN_TOWN | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ...
    ConnectionData(Entrance.town_to_sam_house, RegionName.sam_house, entry_coord=(10, 86),
                   flag=RandomizationFlag.PELICAN_TOWN | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.town_to_haley_house, RegionName.haley_house, entry_coord=(20, 89),
                   flag=RandomizationFlag.PELICAN_TOWN | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.town_to_mayor_manor, RegionName.mayor_house, entry_coord=(58, 86),
                   flag=RandomizationFlag.PELICAN_TOWN | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.town_to_alex_house, RegionName.alex_house, entry_coord=(57, 64),
                   flag=RandomizationFlag.PELICAN_TOWN | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.town_to_trailer, RegionName.trailer, entry_coord=(72, 69),
                   flag=RandomizationFlag.PELICAN_TOWN | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.town_to_museum, RegionName.museum, entry_coord=(101, 90),
                   flag=RandomizationFlag.PELICAN_TOWN | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.town_to_jojamart, RegionName.jojamart, entry_coord=(95, 51),
                   flag=RandomizationFlag.PELICAN_TOWN | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.purchase_movie_ticket, RegionName.movie_ticket_stand, entry_coord=(98, 52)),
    ...
    ConnectionData(Entrance.town_to_beach, RegionName.beach, entry_coord=(54, 108), exit_coord=(38, 1)),
    ConnectionData(Entrance.enter_elliott_house, RegionName.elliott_house, entry_coord=(49, 11),
                   flag=RandomizationFlag.BUILDINGS | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.beach_to_willy_fish_shop, RegionName.fish_shop, entry_coord=(30, 34),
                   flag=RandomizationFlag.NON_PROGRESSION | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ...
    ConnectionData(Entrance.mountain_to_the_mines, RegionName.mines, entry_coord=(54, 5),
                   flag=RandomizationFlag.NON_PROGRESSION | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ...
    ConnectionData(Entrance.enter_skull_cavern_entrance, RegionName.skull_cavern_entrance, entry_coord=(8, 6),
                   flag=RandomizationFlag.BUILDINGS | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.enter_oasis, RegionName.oasis, entry_coord=(6, 52),
                   flag=RandomizationFlag.BUILDINGS | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ...
    ConnectionData(Entrance.enter_bathhouse_entrance, RegionName.bathhouse_entrance, entry_coord=(10, 57),
                   flag=RandomizationFlag.BUILDINGS | RandomizationFlag.LEAD_TO_OPEN_AREA),
...
def create_regions(region_factory: RegionFactory, random: Random, world_options: StardewValleyOptions, content: StardewContent, world) \
    ...
    if world_options.tilesanity < Tilesanity.option_full:
        ...
        regions_by_name, entrances_by_name = create_regions_tilesanity(world, region_factory, regions_data,
                                                                       world.player, random)
