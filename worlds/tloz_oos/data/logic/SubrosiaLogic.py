...
def make_subrosia_logic(player: int):
    return [
        ...
        ["subrosia market sector", "enter Rosa corridor right", OoSEntranceType.Compact, None],
        ...
        ["inside Rosa corridor right", "inside Rosa corridor left", OoSEntranceType.Compact, None],
        ["enter Rosa corridor left", "inside Rosa corridor left", OoSEntranceType.DoorTwoWaySymmetric, lambda state: oos_can_date_rosa(state, player)],
        ["subrosia temple sector", "enter Rosa corridor left", OoSEntranceType.Compact, None],
        ...
        ["subrosia volcano sector", "enter volcano cave", OoSEntranceType.Compact, None],
        ...
        ["subrosia temple sector", "enter dance hall", OoSEntranceType.Compact, None],
        ["enter dance hall", "inside dance hall", OoSEntranceType.DoorTwoWay, None],
        ["inside dance hall", "subrosian dance hall", OoSEntranceType.ReverseCompact, None],

        ["subrosia temple sector", "enter smithy", OoSEntranceType.Compact, None],
        ...
        ["subrosia temple sector", "enter useless subrosian house", OoSEntranceType.Compact, None],
        ["enter useless subrosian house", "inside useless subrosian house", OoSEntranceType.DoorTwoWay, None],

        ["subrosia temple sector", "enter temple of seasons", OoSEntranceType.Compact, None],
        ["enter temple of seasons", "inside temple of seasons", OoSEntranceType.DoorTwoWay, None],
        ["inside temple of seasons", "temple of seasons", OoSEntranceType.ReverseCompact, None],

        ["subrosia temple sector", "enter temple of winter", OoSEntranceType.Compact, None],
        ...
        ["subrosia temple sector", "enter tower of summer", OoSEntranceType.Compact, None],
        ...
        ["subrosia market sector", "enter subrosian market", OoSEntranceType.Compact, None],
        ...
        ["subrosia hide and seek sector", "enter strange brothers right", OoSEntranceType.Compact, None],
        ["enter strange brothers right", "inside strange brothers right", OoSEntranceType.DoorTwoWay, None],
        ["inside strange brothers right", "inside strange brothers left", OoSEntranceType.Compact, None],
        ...
        ["subrosia hide and seek sector", "enter house above hide and seek", OoSEntranceType.Compact, None],
        ...
        ["subrosia hide and seek sector", "enter staircase to tower of spring", OoSEntranceType.TwoWay, lambda state: oos_has_feather(state, player)],
        ...
        ["subrosian 2d cave", "inside tower of spring staircase", OoSEntranceType.Compact, None],
        ["inside tower of spring staircase", "enter tower of spring staircase", OoSEntranceType.DoorTwoWay, None],
        ["enter tower of spring staircase", "enter tower of spring", OoSEntranceType.Compact, None],
        ...
        ["subrosia bridge sector", "enter subrosia locked door", OoSEntranceType.Compact, None],
        ["enter subrosia locked door", "inside subrosia locked door", OoSEntranceType.DoorTwoWay, lambda state: oos_can_date_rosa(state, player)],
        ["inside subrosia locked door", "subrosia, locked cave", OoSEntranceType.ReverseCompact, None],

        ["subrosia bridge sector", "enter subrosian cook", OoSEntranceType.Compact, None],
        ...
        ["inside red ore cave", "inside red ore stairs", OoSEntranceType.Compact, None],
        ["inside red ore stairs", "enter red ore stairs", OoSEntranceType.DoorTwoWay, None],
        ["enter red ore stairs", "subrosia village chest", OoSEntranceType.ReverseCompact, None],

        ["subrosia furnace sector", "enter furnace", OoSEntranceType.Compact, None],
        ...
        ["subrosia furnace sector", "enter sign guy", OoSEntranceType.Compact, None],
