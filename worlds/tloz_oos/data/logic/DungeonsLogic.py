...
def make_d0_logic(player: int):
    return [
        ...
        ["enter d0 chimney", "inside d0 chimney", OoSEntranceType.D0Chimney, lambda state: all([
...
def make_d2_logic(player: int):
    return [
        ...
        ["d2 arrow room", "d2 rupee room", OoSEntranceType.OneWay, lambda state: oos_can_remove_rockslide(state, player, False)],
...
def make_d3_logic(player: int):
    return [
        ...
        ["d3 center", "d3 mimic stairs", OoSEntranceType.OneWay, lambda state: any([
            oos_has_bracelet(state, player),
            all([
        ...
        ["d3 mimic stairs", "d3 bombed wall chest", OoSEntranceType.OneWay, lambda state: oos_can_remove_rockslide(state, player, False)],
...
def make_d4_logic(player: int):
    return [
        ...
        ["d4 terrace", "d4 scrub", OoSEntranceType.OneWay, lambda state: oos_has_rupees_for_shop(state, player, "d4Scrub")],
...
def make_d5_logic(player: int):
    return [
        ...
        ["d5 terrace chest", "d5 armos chest", OoSEntranceType.OneWay, lambda state: any([
            oos_can_kill_armored_enemy(state, player),
            oos_has_bombchus(state, player, 2)
        ])],
...
def make_d6_logic(player: int):
    return [
        ...
        ["d6 1F east", "d6 rupee room", OoSEntranceType.OneWay, lambda state: oos_can_remove_rockslide(state, player, False)],
        ...
        ["d6 beamos room", "d6 2F armos chest", OoSEntranceType.OneWay, lambda state: oos_can_remove_rockslide(state, player, False)],
...
def make_d7_logic(player: int):
    return [
        ...
        ["enter d7", "d7 wizzrobe chest", OoSEntranceType.OneWay, lambda state: oos_can_kill_normal_enemy_no_cane(state, player)],
        ["enter d7", "d7 bombed wall chest", OoSEntranceType.OneWay, lambda state: oos_can_remove_rockslide(state, player, False)],
...
def make_d8_logic(player: int):
    return [
        ...
        ["d8 spinner", "d8 armos chest", OoSEntranceType.OneWay, lambda state: any([
            oos_has_magnet_gloves(state, player),
            all([
        ...
        ["d8 crystal room", "d8 ghost armos drop", OoSEntranceType.OneWay, lambda state: oos_can_remove_rockslide(state, player, False)],
